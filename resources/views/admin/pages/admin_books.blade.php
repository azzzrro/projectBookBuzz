                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class='shadow-none badge badge-primary'> <a
                                                    href="{{ asset('emergency_pic') }}/{{ $data->image }}"
                                                    target="_blank"> View</a>
                                            </span>
                                        </div>
                                    </td>
                                    <td>rs. {{ $data->total_amount }}</td>
                                    <td>rs. {{ $data->collected_amount }}</td>
                                    @if ($data->status == '1')
                                        <td class="text-center"> <span class='shadow-none badge badge-primary'>
                                                <a href="{{ url('/set_emergency/0', $data->id) }}">Active</a></span>
                                        </td>
                                    @else
                                        <td class="text-center"> <span class='shadow-none badge badge-danger'>
                                                <a href="{{ url('/set_emergency/1', $data->id) }}">Deactive</a></span>
                                        </td>
                                    @endif
                                    @if ($data->urgent == '1')
                                        <td class="text-center"> <span class='shadow-none badge badge-primary'>
                                                <a href="{{ url('/set_urgent/0', $data->id) }}">Active</a></span>
                                        </td>
                                    @else
                                        <td class="text-center"> <span class='shadow-none badge badge-danger'>
                                                <a href="{{ url('/set_urgent/1', $data->id) }}">Deactive</a></span>
                                        </td>
                                    @endif
                                    @if ($data->completed == '1')
                                        <td class="text-center"> <span class='shadow-none badge badge-primary'>
                                                <a href="{{ url('/set_completed/0', $data->id) }}">Active</a></span>
                                        </td>
                                    @else
                                        <td class="text-center"> <span class='shadow-none badge badge-danger'>
                                                <a href="{{ url('/set_completed/1', $data->id) }}">Deactive</a></span>
                                        </td>
                                    @endif
                                    <td>{{ $data->created_at }}</td>
                                    <td class="text-center">
                                        <div class="dropdown custom-dropdown">
                                            <a href="{{ url('/delete_emergency', $data->id) }}"><svg
