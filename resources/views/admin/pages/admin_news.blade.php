    ...
    <div class="page-header">
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">News</a></li>
            </ol>
        </nav>
    </div>
                ...
                <div id="toggleAccordion">
                    <div class="card">
                        ...
                        <div id="defaultAccordionColor" class="collapse" aria-labelledby="headingThree1"
                            ...
                            <div class="card-body">
                                <form action="{{ url('/admin_upload_news') }}" method="post"
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <span class='shadow-none badge badge-primary'> <a
                                                    href="{{ asset('news_pic') }}/{{ $data->image }}"
                                    ...
                                    @if ($data->status == '1')
                                        <td class="text-center"> <span class='shadow-none badge badge-primary'>
                                                <a href="{{ url('/set_news/0', $data->id) }}">Active</a></span>
                                        </td>
                                    @else
                                        <td class="text-center"> <span class='shadow-none badge badge-danger'>
                                                <a href="{{ url('/set_news/1', $data->id) }}">Deactive</a></span>
                                        </td>
                                    @endif
                                    <td>{{ $data->created_at }}</td>
                                    <td class="text-center">
                                        <div class="dropdown custom-dropdown">
                                            <a href="{{ url('/delete_news', $data->id) }}"><svg
